...
select sql_cript,sort_id
    from (
    select toInt64(data_compressed_bytes) as sort_id, 'ALTER TABLE '||cc.database||'.'||cc.table||' CLEAR COLUMN '||cc.name||' IN PARTITION '||pp.partition||';' as sql_cript
